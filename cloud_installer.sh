...
PostUp = iptables -A FORWARD -i eth0 -o wg0 -p tcp --syn --dport 2222 -m conntrack --ctstate NEW -j ACCEPT
...
PostUp = iptables -t nat -A PREROUTING -i eth0 -p tcp --dport 2222 -j DNAT --to-destination 192.168.4.2
...
PostUp = iptables -t nat -A POSTROUTING -o wg0 -p tcp --dport 2222 -d 192.168.4.2 -j SNAT --to-source 192.168.4.1
...
PostDown = iptables -D FORWARD -i eth0 -o wg0 -p tcp --syn --dport 2222 -m conntrack --ctstate NEW -j ACCEPT
...
PostDown = iptables -t nat -D PREROUTING -i eth0 -p tcp --dport 2222 -j DNAT --to-destination 192.168.4.2
...
PostDown = iptables -t nat -D POSTROUTING -o wg0 -p tcp --dport 2222 -d 192.168.4.2 -j SNAT --to-source 192.168.4.1
